<group 
name="liuchangqing" 
ht="{data(doc('/Users/brantiusxiong/GitHub/AsianPoetry/Data/xml_files/chinese_poetry/Combined%20Worksheet2.xml')//persons/person[@xml:id='liuchangqing']/@hometown)}"
lp="{data(doc('/Users/brantiusxiong/GitHub/AsianPoetry/Data/xml_files/chinese_poetry/Combined%20Worksheet2.xml')//persons/person[@xml:id='liuchangqing']/@living_place)}"
rp="{data(doc('/Users/brantiusxiong/GitHub/AsianPoetry/Data/xml_files/chinese_poetry/Combined%20Worksheet2.xml')//persons/person[@xml:id='liuchangqing']/@related_place)}">
<place name="jjd">
{let $doc := doc('/Users/brantiusxiong/GitHub/AsianPoetry/Data/xml_files/chinese_poetry/Combined%20Worksheet2.xml')
let $author := $doc//title/author[@ref='liuchangqing']
