    ...
    <xsl:template match="/">
        <svg>
            <g transform="translate(200,450) scale(1.5)">
                ...
                <xsl:variable name="average" select="//types[@eng='G']/type[@type='total-total'] * 100 * 5"/>
                
                
                
                <xsl:for-each select="//types[@eng='G']/type[not(@type='total-total')]">
                ...
                <text x="600" y="20" text-anchor="end">Given Name</text>
