        ...
        <svg width="400" height="250">
            <g transform="translate(150, 200)">
                ...
                <xsl:variable name="mPerI" as="xs:double"
                    select="100 * count(//book[@num = 'I']/p/person[@type='author' and @sex = 'male']) div count(//book[@num = 'I']/p/person[@type='author'])"/>
                <xsl:variable name="fPerI" as="xs:double"
                    select="100 * count(//book[@num = 'I']/p/person[@type='author' and @sex = 'female']) div count(//book[@num = 'I']/p/person[@type='author'])"/>
                <xsl:variable name="uPerI" as="xs:double"
                    select="100 * count(//book[@num = 'I']/p/person[@type='author' and @sex = 'unknown']) div count(//book[@num = 'I']/p/person[@type='author'])"/>
                ...
                <xsl:variable name="mPerII" as="xs:double"
                    select="100 * count(//book[@num = 'II']/p/person[@type='author' and @sex = 'male']) div count(//book[@num = 'II']/p/person[@type='author'])"/>
                <xsl:variable name="fPerII" as="xs:double"
                    select="100 * count(//book[@num = 'II']/p/person[@type='author' and @sex = 'female']) div count(//book[@num = 'II']/p/person[@type='author'])"/>
                <xsl:variable name="uPerII" as="xs:double"
                    select="100 * count(//book[@num = 'II']/p/person[@type='author' and @sex = 'unknown']) div count(//book[@num = 'II']/p/person[@type='author'])"/>
                ...
                <xsl:variable name="mPerIV" as="xs:double"
                    select="100 * count(//book[@num = 'IV']/p/person[@type='author' and @sex = 'male']) div count(//book[@num = 'IV']/p/person[@type='author'])"/>
                <xsl:variable name="fPerIV" as="xs:double"
                    select="100 * count(//book[@num = 'IV']/p/person[@type='author' and @sex = 'female']) div count(//book[@num = 'IV']/p/person[@type='author'])"/>
                <xsl:variable name="uPerIV" as="xs:double"
                    select="100 * count(//book[@num = 'IV']/p/person[@type='author' and @sex = 'unknown']) div count(//book[@num = 'IV']/p/person[@type='author'])"/>
                ...
                <xsl:variable name="mPerVIII" as="xs:double"
                    select="100 * count(//book[@num = 'VIII']/p/person[@type='author' and @sex = 'male']) div count(//book[@num = 'VIII']/p/person[@type='author'])"/>
                <xsl:variable name="fPerVIII" as="xs:double"
                    select="100 * count(//book[@num = 'VIII']/p/person[@type='author' and @sex = 'female']) div count(//book[@num = 'VIII']/p/person[@type='author'])"/>
                <xsl:variable name="uPerVIII" as="xs:double"
                    select="100 * count(//book[@num = 'VIII']/p/person[@type='author' and @sex = 'unknown']) div count(//book[@num = 'VIII']/p/person[@type='author'])"/>
                ...
                <text x="-70" y="-150" font-size="15px">Gender Distribution Throughout the Books</text>
