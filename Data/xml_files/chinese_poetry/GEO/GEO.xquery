<group 
name="wangwei" 
ht="{data(doc('/Users/brantiusxiong/GitHub/AsianPoetry/Data/xml_files/chinese_poetry/Combined%20Worksheet2.xml')//persons/person[@xml:id='wangwei']/@hometown)}"
lp="{data(doc('/Users/brantiusxiong/GitHub/AsianPoetry/Data/xml_files/chinese_poetry/Combined%20Worksheet2.xml')//persons/person[@xml:id='wangwei']/@living_place)}"
rp="{data(doc('/Users/brantiusxiong/GitHub/AsianPoetry/Data/xml_files/chinese_poetry/Combined%20Worksheet2.xml')//persons/person[@xml:id='wangwei']/@related_place)}">
<place name="jjd">
{let $doc := doc('/Users/brantiusxiong/GitHub/AsianPoetry/Data/xml_files/chinese_poetry/Combined%20Worksheet2.xml')
let $author := $doc//title/author
let $person := $author/preceding-sibling::person/@ref
let $biography := $doc//persons/person
where $author/@ref = 'wangwei'
